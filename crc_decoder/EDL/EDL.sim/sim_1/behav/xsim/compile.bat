...
REM
REM Generated by Vivado on Thu Jan 15 08:35:59 +0530 2026
...
echo "xvlog --incr --relax -prj BB_Descrambler_tb_vlog.prj"
call xvlog  --incr --relax -prj BB_Descrambler_tb_vlog.prj -log xvlog.log
