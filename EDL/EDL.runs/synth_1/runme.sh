...
HD_PWD='D:/EDL_V1/EDL/EDL.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BB_Descrambler.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BB_Descrambler.tcl
